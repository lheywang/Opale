 ...
 */
/*
 * For precalculated values, see documentation/excel/Te_calc.xlsx tab !
 */

// Sample rate of the ADC (Trigger a sequencer every X us !)
#define SAADC_CHANNEL_SAMPLE_RATE 50 // us

// Buffer lengh. How many measures we want for ALL channels
#define SAADC_BUFFER_SIZE 200 // 120 mseconds
...
static volatile nrfx_saadc_channel_t channels[SAADC_INPUT_COUNT] = {NRFX_SAADC_DEFAULT_CHANNEL_SE(NRF_SAADC_INPUT_AIN7, 0),
 ...
 * -----------------------------------------------------------------
 */
static volatile int16_t saadc_buffer[2][SAADC_BUFFER_SIZE] = {0};
static volatile uint32_t saadc_buffer_index = 0;

/** ================================================================
 * @file    application/src/init/init.hpp
 *
 * @brief   init.hpp is charged to fetch the DT node label from the
...
namespace initializer
{
     ...
     */
    struct gpio_dt_spec *GetAGPIO(GPIOS Pin);
     ...
     * @return  Nothing
     */
    void FreeAGPIO(GPIOS Pin, struct gpio_dt_spec *GPIO);
     ...
     */
    struct pwm_dt_spec *GetAPWM(PWMS Dev);
     ...
     * @return  Nothing
     */
    void FreeAPWM(PWMS Dev, struct pwm_dt_spec *PWM);
     ...
     */
    struct spi_dt_spec *GetAnSPI(SPIS Dev);
     ...
     * @return  Nothing
     */
    void FreeAnSPI(SPIS Dev, struct spi_dt_spec *SPI);
     ...
     */
    const struct i2c_dt_spec *GetAnI2C(I2CS Dev);
     ...
     * @return  Nothing
     */
    void FreeAnI2C(I2CS Dev, const struct i2c_dt_spec *I2C);
     ...
     */
    const struct device *GetAnUART(UARTS Dev);
     ...
     * @return  Nothing
     */
    void FreeAnUART(UARTS Dev, const struct device *UART);
    /**
     ...
     */
    nrfx_timer_t *GetATimer(TIMERS Dev);
     ...
     * @return  Nothing
     */
    void FreeATimer(TIMERS Dev, nrfx_timer_t *Timer);
}
#endif /* DEF_INIT*/

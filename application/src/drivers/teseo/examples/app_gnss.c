...
static int GetSWVerCmdIsAllowed(char *com)
{
    int ret = 0;
#ifdef TESEO_LIV3F_DEVICE
    if ((com[13] == '\0') || (((com[14] == '1') || (com[14] == '2') || (com[14] == '4') || (com[14] == '6') || (com[14] == '7') || (com[14] == '8')) && (com[15] == '\0')) || ((com[14] == '2') && (com[15] == '5') && (com[16] == '5') && (com[17] == '\0')))
    {
        ret = 1;
    }
#endif
#ifdef TESEO_VIC3DA_DEVICE
    if ((com[13] == '\0') || (((com[14] == '1') || (com[14] == '2') || (com[14] == '6') || (com[14] == '7') || (com[14] == '8')) && (com[15] == '\0')) || ((com[14] == '1') && ((com[15] == '0') || (com[15] == '1') || (com[15] == '2')) && (com[16] == '\0')) || ((com[14] == '2') && (com[15] == '5') && (com[16] == '5') && (com[17] == '\0')))
    {
        ret = 1;
    }
#endif

...
void system_init(void)
{
	...
	gpio_set_pin_level(mcp23008_reset_pin,
	                   // <y> Initial level
	...
	gpio_set_pin_level(user_led_green,
	                   // <y> Initial level
	                   // <id> pad_initial_level
	                   // <false"> Low
	                   // <true"> High
	...
	// Set pin direction to output
	gpio_set_pin_direction(user_led_green, GPIO_DIRECTION_OUT);

	gpio_set_pin_function(user_led_green, GPIO_PIN_FUNCTION_OFF);

	// GPIO on PA25

	gpio_set_pin_level(user_led_blue,
	                   // <y> Initial level
	                   // <id> pad_initial_level
	                   // <false"> Low
	                   // <true"> High
